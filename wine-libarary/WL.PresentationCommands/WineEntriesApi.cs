...
{
    public class WineEntriesApi
    {
        private readonly ICommandFactory _commandFactory;
        private readonly IRequestProcessor _requestProcessor;
        private const string Name = "wineentries";

        public WineEntriesApi(ICommandFactory commandFactory, IRequestProcessor requestProcessor)
        {
        ...
        public async Task<IActionResult> Post(
            ...
            await _requestProcessor.ProcessRequest(Name,
                async () => _commandFactory.CreateWineCommand(await _requestProcessor.ReadBodyAsync<CreateWineBody>(req), req.Headers),
                messages);
